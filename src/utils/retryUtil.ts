 ...
 */
export function isRetriableStatus(status?: number, retryableStatusCodes = DEFAULT_RETRY_OPTIONS.retryableStatusCodes): boolean {
 ...
 */
export function isRetriableError(error: any, retryableStatusCodes = DEFAULT_RETRY_OPTIONS.retryableStatusCodes): boolean {
