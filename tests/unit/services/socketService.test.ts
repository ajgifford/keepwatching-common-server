...
describe('SocketService', () => {
  ...
  describe('exported singleton instance', () => {
    it('should export a singleton instance', () => {
      // The exported socketService is created when the module loads
      // We verify it's a SocketService instance
      expect(socketService).toBeDefined();
      expect(socketService.isInitialized).toBeDefined();
      expect(socketService.initialize).toBeDefined();
      expect(socketService.shutdown).toBeDefined();
    });
  });
});
